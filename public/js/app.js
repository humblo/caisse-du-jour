...
$(document).ready(function () {
  $('button').click(function (e) {
    ...
    var counter_cumul = parseInt(counter) + 1;
    var optionSelect = setOption(type);
    $("#box-hidden .nominal-select").html(optionSelect);
    $('#box-hidden .nominal-select').attr('name', "".concat(type, "[").concat(counter_cumul, "][operation]"));
    $('#box-hidden .nominal-select').attr('id', "".concat(type, "_operation_").concat(counter_cumul));
...
function calcul(type) {
  var total = 0;
  $(".box-".concat(type, " input.form-control")).each(function (index, item) {
